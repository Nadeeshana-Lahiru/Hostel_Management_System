...
<div class="details-container">
    <div class="details-header">
        ...
        <div class="actions">
            <a href="{{ route('admin.students.index') }}" class="btn btn-secondary">&larr; Back to List</a>
            <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-warning">Edit Student</a>
        </div>
    </div>
