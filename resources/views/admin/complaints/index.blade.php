...
<style>
    ...
    .status-pending { background-color: #f6c23e; } /* Yellow */
...
<div class="filter-tabs">
    <a href="{{ route('admin.complaints.index') }}" class="btn {{ !request('status') ? 'active' : '' }}">All</a>
    <a href="{{ route('admin.complaints.index', ['status' => 'pending']) }}" class="btn {{ request('status') == 'pending' ? 'active' : '' }}">Pending</a>
    <a href="{{ route('admin.complaints.index', ['status' => 'in_progress']) }}" class="btn {{ request('status') == 'in_progress' ? 'active' : '' }}">In Progress</a>
    <a href="{{ route('admin.complaints.index', ['status' => 'completed']) }}" class="btn {{ request('status') == 'completed' ? 'active' : '' }}">Completed</a>
</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="{{ route('admin.complaints.show', $complaint->id) }}" class="btn btn-primary">View / Reply</a>
                </td>
            </tr>
            @empty
            <tr>
