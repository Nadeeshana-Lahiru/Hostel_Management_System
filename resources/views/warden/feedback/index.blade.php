...
<div class="page-header">
    ...
    <a href="{{ route('warden.feedback.questions') }}" class="btn btn-primary">Manage Questions</a>
</div>
...
<div class="report-grid">
    ...
    @empty
        <div class="chart-card" style="grid-column: 1 / -1;">
            <p>No feedback has been submitted yet. <a href="{{ route('warden.feedback.questions') }}">Manage Questions</a></p>
        </div>
    @endforelse
</div>
