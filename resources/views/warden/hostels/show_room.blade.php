...
<div class="page-header">
    ...
    <a href="{{ route('warden.hostels.show', $room->hostel->id) }}" class="btn-secondary">&larr; Back to Floor Plan</a>
</div>
...
<div class="table-container">
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{ route('warden.students.show', $student->id) }}" class="student-name-link">
                        {{ $student->full_name }}
                    </a>
                </td>
