...
<div class="settings-card">
    ...
    <div class="settings-section">
        ...
        {{-- The logout route is global, no change needed here --}}
    ...
    <div class="modal-content">
        ...
        <div id="step2" class="modal-step">
            ...
            <form id="verifyOtpForm">
                @csrf
                <div class="form-group"><label for="otp">6-Digit OTP</label><input type="text" id="otp" name="otp" required></div>
        ...
        <div id="step3" class="modal-step">
            ...
            <form id="changePasswordForm" action="{{ route('student.settings.changePassword') }}" method="POST">
                @csrf
                <div class="form-group"><label for="password">New Password</label><input type="password" name="password" required></div>
                <div class="form-group" style="margin-top: 1rem;"><label for="password_confirmation">Confirm New Password</label><input type="password" name="password_confirmation" required></div>
