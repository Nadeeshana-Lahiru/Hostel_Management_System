...
<head>
    ...
    <style>
        /* === MODIFIED - General body and font styles (Same as Admin/Warden) === */
        body { 
        ...
        /* === NEW STYLES FOR THE SIDEBAR - Copied from Admin/Warden Panel for consistency === */
        .sidebar {
            width: 260px;
        ...
        <nav class="sidebar">
            ...
            <ul>
                <li class="{{ request()->routeIs('student.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('student.dashboard') }}"><i class="fas fa-tachometer-alt nav-icon"></i> Dashboard</a>
                </li>
                <li class="{{ request()->routeIs('student.room.*') ? 'active' : '' }}">
                    <a href="{{ route('student.room.index') }}"><i class="fas fa-bed nav-icon"></i> My Room</a>
                </li>
                <li class="{{ request()->routeIs('student.complaints.*') ? 'active' : '' }}">
                    <a href="{{ route('student.complaints.index') }}"><i class="fas fa-exclamation-circle nav-icon"></i> Complaints</a>
                </li>
                <li class="{{ request()->routeIs('student.feedback.*') ? 'active' : '' }}">
                    <a href="{{ route('student.feedback.index') }}"><i class="fas fa-comment-dots nav-icon"></i> Feedback</a>
                </li>
                <li class="{{ request()->routeIs('student.settings.*') ? 'active' : '' }}">
                    <a href="{{ route('student.settings.index') }}"><i class="fas fa-cog nav-icon"></i> Settings</a>
                </li>
            </ul>
             <!-- === END MODIFIED === -->
        </nav>
